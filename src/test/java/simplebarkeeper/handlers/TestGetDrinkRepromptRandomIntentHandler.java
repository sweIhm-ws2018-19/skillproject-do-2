...
public class TestGetDrinkRepromptRandomIntentHandler {

	private GetDrinkRepromptRandomIntentHandler testHandler;

	@Before
	public void setup() {
		testHandler = new GetDrinkRepromptRandomIntentHandler();
	}

	@Test
	public void testCanHandle() {
		Map<String, Object> sessAtt = new HashMap<String, Object>();
		sessAtt.put(States.GET_DRINK_STATE_KEY, States.GET_DRINK_REPROMPT_RANDOM);
	...
	public void testHandleYes() {
		...
		assertTrue(sessionAttributesAfterHandle.get(States.GET_DRINK_STATE_KEY).equals(States.GET_DRINK_REPROMPT_RANDOM));
	}
	
	@Test
	public void testHandleNo() {
		Map<String, Object> sessAtt = new HashMap<String, Object>();
		sessAtt.put(States.GET_RECIPE_STATE_KEY, States.GET_DRINK_REPROMPT_RANDOM);
		sessAtt.put(States.GET_DRINK_INGREDIENT_KEY, "cola");
		sessAtt.put(States.GET_DRINK_CONTAINS_ALCOHOL_KEY, "false");
		String answer = "nein";
		final HandlerInput mockInput = TestUtil.mockHandlerInputChooseAlcohol(answer, sessAtt, null, null);
