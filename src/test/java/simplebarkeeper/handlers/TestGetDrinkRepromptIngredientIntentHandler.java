...
public class TestGetDrinkRepromptIngredientIntentHandler {

	private GetDrinkRepromptIngredientIntentHandler testHandler;

	@Before
	public void setup() {
		testHandler = new GetDrinkRepromptIngredientIntentHandler();
	}

	@Test
	public void testCanHandle() {
		Map<String, Object> sessAtt = new HashMap<String, Object>();
		sessAtt.put(States.GET_DRINK_STATE_KEY, States.GET_DRINK_REPROMPT_INGREDIENT);
	...
	public void testHandleYes() {
		Map<String, Object> sessAtt = new HashMap<String, Object>();
		sessAtt.put(States.GET_RECIPE_STATE_KEY, States.GET_DRINK_REPROMPT_INGREDIENT);
		sessAtt.put(States.GET_DRINK_INGREDIENT_KEY, "cola");
		...
		assertTrue(sessionAttributesAfterHandle.get(States.GET_DRINK_STATE_KEY).equals(States.GET_DRINK_REPROMPT_INGREDIENT));
	}
