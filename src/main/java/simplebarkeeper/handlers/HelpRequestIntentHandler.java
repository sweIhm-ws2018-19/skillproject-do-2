...
public class HelpRequestIntentHandler implements RequestHandler {
	...
	public boolean canHandle(HandlerInput input) {
		...
		return input.matches(intentName("AMAZON.HelpIntent")) && attributes.get("HelpState").equals("HelpStateAbfragen");
	}
	...
	public Optional<Response> handle(HandlerInput input) {
		String outputText = "Sie können die Zutaten eines Drinks wie folgt abfragen ...";
		Map<String, Object> attributes = input.getAttributesManager().getSessionAttributes();
